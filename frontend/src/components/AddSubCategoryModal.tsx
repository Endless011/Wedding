...
interface AddSubItemModalProps {
    visible: boolean;
    onClose: () => void;
    onAdd: (subItem: { name: string; description?: string; color: string; icon?: string; price?: number; purchasedQuantity: number }) => void;
    categoryColor: string;
    categoryName: string;
    categoryTotalQuantity: number;
    currentPurchasedTotal: number; // Sum of purchasedQuantity of existing sub-items
}
                ...
                <View style={[styles.modalContainer, { backgroundColor: colors.surface }]}>
                    <View style={styles.header}>
                        <View>
                            ...
                            <Text style={[styles.categoryLabel, { color: colors.textSecondary }]}>
                                {categoryName} (Kalan: {remainingQuantity})
                            </Text>
                        </View>
                    ...
                    <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
                        ...
                        <TextInput
                            ...
                            placeholder="Örn: Madame Coco, English Home..."
                        ...
                        {/* Price Input */}
                        <Text style={[styles.label, { color: colors.textSecondary }]}>Birim Fiyat (Opsiyonel)</Text>
                        ...
                        {/* Description Input */}
                        <Text style={[styles.label, { color: colors.textSecondary }]}>Açıklama (Opsiyonel)</Text>
                        <TextInput
                            style={[styles.input, { backgroundColor: colors.background, color: colors.textPrimary, borderColor: colors.cardBorder }]}
                            placeholder="Notlar..."
                            placeholderTextColor={colors.gray}
                        ...
                        {/* Icon Selection */}
                        <Text style={[styles.label, { color: colors.textSecondary }]}>Emoji (Opsiyonel)</Text>
