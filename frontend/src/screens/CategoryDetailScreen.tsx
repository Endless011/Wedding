...
export default function CategoryDetailScreen() {
    ...
    const handleSaveCategory = (updates: Partial<Category>) => {
        // Optimistic Update for Target Quantity if present
        if (updates.targetQuantity) {
            setLocalTarget(updates.targetQuantity);
        }

        editCategory(groupId, category.id, updates);
